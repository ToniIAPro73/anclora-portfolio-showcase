...
Declaración de adopción AOS para .

## Metadatos

- Repository Name: anclora-portfolio-showcase
...
## Propósito del repositorio
 ...
 forma parte del ecosistema Anclora. Static showcase repository.
...
- Bóveda (Contratos y Censo): [](../../anclora-vault/00-governance/)

## Fuentes oficiales locales

| Tipo de conocimiento | Ruta local | Owner | Relación con AOS |
| --- | --- | --- | --- |
| Contexto de agente | [](AGENT_PROJECT_CONTEXT.md) | ToniIAPro73 | Fuente local de bootstrap de agentes (v1.0). |
| Guía de runtime | [](PRODUCTION_RUNTIME.md) | ToniIAPro73 | Contrato de runtime operativo (v1.0). |
| Identidad y reglas | [](../AGENTS.md) | ToniIAPro73 | Reglas locales subordinadas a AOS. |
